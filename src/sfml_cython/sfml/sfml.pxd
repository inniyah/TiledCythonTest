...
cimport sfml.style as style, sfml.event as event, sfml.videomode as videomode
cimport sfml.contextsettings as contextsettings, sfml.keyboard as keyboard
cimport sfml.joystick as joystick, sfml.mouse as mouse, sfml.touch as touch, sfml.sensor as sensor
...
cimport sfml.blendmode as blendmode, sfml.primitivetype as primitivetype, sfml.texture as texture, sfml.shader as shader
cimport sfml.font as font, sfml.text as text, sfml.renderstates as renderstates, sfml.transform as transform
...
from libcpp.string cimport string
cimport sfml.listener as listener, sfml.soundsource as soundsource
cimport sfml.soundrecorder as soundrecorder, sfml.soundstream as soundstream
...
cimport sfml.ipaddress as ipaddress, sfml.socket as socket
cimport sfml.udpsocket as udpsocket, sfml.ftp as ftp, sfml.http as http
